...
@test Convertible("2014-1") |> input_to_period_tuple |> to_value == ("month", (2014, 1))
@test Convertible("month:2014") |> input_to_period_tuple |> to_value == ("month", "2014")
@test Convertible("day:2014") |> input_to_period_tuple |> to_value == ("day", "2014")

@test Convertible(2014) |> to_period |> to_value == YearPeriod(2014)
@test Convertible("2014") |> to_period |> to_value == YearPeriod(2014)
@test Convertible("2014:2") |> to_period |> to_value == YearPeriod(2014, 2)
@test Convertible("2014-1") |> to_period |> to_value == MonthPeriod(Date(2014, 1, 1))
...
@test Convertible("2014-1-1") |> to_period |> to_value == DayPeriod(Date(2014, 1, 1))
